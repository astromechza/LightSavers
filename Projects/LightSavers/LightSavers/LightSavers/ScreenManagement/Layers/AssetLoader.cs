...
namespace LightSavers
{
    ...
    public class AssetLoader : ScreenLayer
    {
        ...
        private void LoadAssets()
        {
            ...
            Globals.audioManager.LoadGameSound(snd_alien_death1, "aliendeath1",3,Globals.audioManager.alienDeath1);
            Globals.audioManager.LoadGameSound(snd_pistol, "pistol", 5, Globals.audioManager.pistol);
            Globals.audioManager.LoadGameSound(snd_shottie, "shottie", 3, Globals.audioManager.shottie);
            Globals.audioManager.LoadGameSound(snd_sniper, "sniper", 3, Globals.audioManager.sniper);
            Globals.audioManager.LoadGameSound(snd_sword, "sword", 3, Globals.audioManager.sword);
            Globals.audioManager.LoadGameSound(snd_assault, "assault", 10, Globals.audioManager.assault);
