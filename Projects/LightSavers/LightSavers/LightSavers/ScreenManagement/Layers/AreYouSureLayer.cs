...
{
    class AreYouSureLayer : ScreenLayer
    {
        ...
        private void ConstructDrawingObjects()
        {
            ...
            int tx = (viewport.Width - 463) / 2;
            titleRect = new Rectangle(tx, (viewport.Height - 214)/2, 463, 214);
        }
        ...
        private void ConstructSubMenus()
        {
            ...
            if (exitUrgency == 0)
            {
                s2.AddItem(new DelegateItem("Yes", Yes, Color.White, Color.Gray));
                s2.AddItem(new DelegateItem("No", No, Color.White, Color.Gray));
            }
            else
            {
        ...
        public override void Draw()
        {
            ...
            canvas.DrawString(AssetLoader.fnt_paragraph, message, new Vector2((viewport.Bounds.Width - 463) / 2 + 30, (viewport.Bounds.Height - 214) / 2 + 30), Color.White);
        ...
        {
            canvas.Draw(AssetLoader.questionRect, titleRect, Color.White);
