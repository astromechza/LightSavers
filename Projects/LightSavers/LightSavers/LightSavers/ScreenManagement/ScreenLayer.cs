...
namespace LightSavers.ScreenManagement
{
    ...
    public abstract class ScreenLayer
    {
        ...
        private bool UpdateTransition(float millis, TimeSpan totalTime, int direction)
        {
            float delta;
            ...
            if (totalTime == TimeSpan.Zero)
                ...
                delta = (float)(millis / totalTime.TotalMilliseconds);
        ...
        public virtual void Update(float millis)
        {
            switch (state)
            {
                ...
                case ScreenState.TransitioningOff:
                    if (UpdateTransition(millis, transitionOffTime, -1))
                    {
        ...
        public abstract void Draw(float millis);
