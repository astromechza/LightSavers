...
namespace LightSavers.Components
{
    ...
    public class Camera
    {
        ...
        private float _tanFovy = (float)Math.Tan(MathHelper.ToRadians(22.5f));
        ...
        public Matrix Transform
        {
            ...
            { 
                ...
                _frustum.Matrix = _viewMatrix * _projectionMatrix;
            }
        }
        ...
        public float FovYDegrees
        {
            ...
            { 
                _fovYDegrees = value;
                _tanFovy = (float) Math.Tan(MathHelper.ToRadians(_fovYDegrees));
                ComputeProjectionTransform();
            }
        }
        ...
        {
            Matrix.CreatePerspectiveFieldOfView(MathHelper.ToRadians(_fovYDegrees), Aspect, _nearClip, _farClip, out _projectionMatrix);
            Matrix.Multiply(ref _viewMatrix, ref _projectionMatrix, out _viewProjectionMatrix);
            _frustum.Matrix = _viewMatrix * _projectionMatrix;
        }
        ...
        public void ProjectBoundingSphereOnScreen(BoundingSphere boundingSphere, out Vector2 topLeft, out Vector2 size)
        {
            ...
            Vector3 l = Vector3.Transform(boundingSphere.Center, _viewMatrix);
            ...
            size = new Vector2(scissorRight - scissorLeft, scissorTop - scissorBottom);
            topLeft = new Vector2(scissorLeft, -scissorBottom - size.Y);
        }
    }
}
